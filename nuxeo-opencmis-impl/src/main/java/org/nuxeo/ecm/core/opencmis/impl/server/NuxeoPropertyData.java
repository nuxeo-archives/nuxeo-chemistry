...
public abstract class NuxeoPropertyData<T> extends NuxeoPropertyDataBase<T> {
    ...
    public NuxeoPropertyData(PropertyDefinition<T> propertyDefinition, DocumentModel doc,
    ...
    @SuppressWarnings("unchecked")
    protected static Object convertToCMIS(Object value) throws IOException {
    ...
    protected static Object convertComplexPropertyToCMIS(ComplexProperty prop, CallContext callContext)
        ...
        org.nuxeo.ecm.automation.core.util.DateTimeFormat nuxeoDateTimeFormat =
                (cmisDateTimeFormat.equals(DateTimeFormat.SIMPLE))
    ...
    protected static Object convertToNuxeo(Object value, Type type) throws IOException {
        if (value instanceof BigDecimal) {
            ...
            return ComplexTypeJSONDecoder.decode(
